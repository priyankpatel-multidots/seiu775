        ...
        <table class="ina-form-tbl form-table">
          ...
          <tr class="ina-hide-section" <?php echo ! empty( $ina_warn_message_enabled ) ? 'style="display:none;"' : 'style="display:table-row;"'; ?>>
            ...
            <td>
              ...
              <p class="description"><?php esc_html_e( 'When the timeout pop-up appears, the user is not logged out instantly. It allows the user the chance to continue, or a logout will occur within 10 seconds. Check this box in order to immediately logout the user after the idle timeout minute.', 'inactive-logout' ); ?></p>
            </td>
          </tr>
          <tr>
